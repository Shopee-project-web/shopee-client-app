// ProductByCategoryId.js
import React, {useEffect, useState} from 'react';
import axios from 'axios';
import {Link, useParams} from "react-router-dom";
import {MdStarRate} from "react-icons/md";
import ReactPaginate from "react-paginate";
import {findProductByCategoryList, findProductById, findProductList} from "../../api/productAPI";
...
function ProductByCategoryId() {
  ...
  const getProductListData = async (categoryId) => {
    try {
      const response = await findProductByCategoryList(categoryId);
  ...
  useEffect(() => {
    console.log("categoryId truyền vào:" + categoryId);
    getProductListData();
  }, [categoryId]);
